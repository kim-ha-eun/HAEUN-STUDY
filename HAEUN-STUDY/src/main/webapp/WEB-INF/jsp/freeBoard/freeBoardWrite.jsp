                 ...
                 <div class="card-body">
                       ...
                       <div id="editor" style=" margin-top:20px;">
					    ...
					    <div class="card-body" style="text-align: center;">
		                     <button id="edit" class="btn btn-info btn-rounded" onclick="list()" type="button">목록</button>
		                     <button id="save" class="btn btn-success btn-rounded" onclick="save()" type="button">저장</button>
		                 </div>
                 </div>
             </div>
<!--              <div class="card"> -->
<!--                  <div class="card-body" style="text-align: center;"> -->
<!--                      <button id="edit" class="btn btn-info btn-rounded" onclick="edit()" type="button">수정</button> -->
<!--                      <button id="save" class="btn btn-success btn-rounded" onclick="save()" type="button">저장</button> -->
<!--                  </div> -->
<!--              </div> -->
         </div>
